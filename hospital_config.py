...
ROOMS = [
    ...
    # EMERGENCY ROOM (Key for your new requirement)
...
SURGEONS = {
    ...
    # Visiting Consultants (Infinite Capacity Backup)
...
CONSTANTS = {
    ...
    'DAY_END': 22 * 60,    # Extended to 10:00 PM for emergencies
    'TURNOVER': 30,        # Room Cleaning time
    'SURGEON_BREAK': 30    # NEW: Mandatory Surgeon Break
}
